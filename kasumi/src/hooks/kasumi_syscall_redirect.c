...
core_param(kasumi_tsr_basic, kasumi_tsr_basic_param, int, 0600);
/* DBG: TSR hooks only openat/reboot/prctl (skip stat/statfs/read/write/getdents/xattr) to isolate crashing handler. */
