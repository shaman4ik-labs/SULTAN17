...
INC_ANCHOR="#if defined(CONFIG_KSU_SUSFS_SUS_KSTAT) || defined(CONFIG_KSU_SUSFS_SUS_MAP)\n#include <linux/susfs_def.h>"
INC_INJECT="#ifdef CONFIG_ZEROMOUNT\n#include <linux/zeromount.h>\n#endif\n"+INC_ANCHOR
...
def main():
    ...
    if INC_ANCHOR not in c: print("ERROR: susfs_def include anchor missing in task_mmu.c",file=sys.stderr); sys.exit(1)
